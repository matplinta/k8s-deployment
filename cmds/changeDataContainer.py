...
index = None
for idx, elem in enumerate(yaml_instance['spec']['template']['spec']['containers']):
    if elem['name'] == 'workflow-data':
        index = idx
yaml_instance['spec']['template']['spec']['containers'][index]['image'] = CONTAINER
